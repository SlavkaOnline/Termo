...
xMBPortTimersInit( USHORT usTim1Timerout50us )
{
    ...
    T1PR = 0;                   // Prscaler Register = 0
    T1PC = 0;                   // Prscaler Counter = 0

    T1TC = 0;                   // Timer Counter = 0

    T1MR0 = ( PCLK / 20000 ) * usTim1Timerout50us;      // Interval of (50us * usTim1Timerout50us)
    T1MCR = 3;                  // Bit 0 = 1 - Interruption on MR0
...
vMBPortTimersEnable(  )
{
    T1TCR = 0x02;               // Disable Timer and Reset Counter
